...
GlobalCommandLineParser::ParseResult GlobalCommandLineParser::parse(const QStringList &args)
{
    ...
    parser.setApplicationDescription(
        "\n"
        "Starts Space Connect normally if no arguments are given.\n"
        "\n"
        "Available actions:\n"
        ...
        "\n"
        "See 'spaceconnect <action> --help' for help of specific action."
    );
...
void StreamCommandLineParser::parse(const QStringList &args, StreamingPreferences *preferences)
{
    ...
    parser.addToggleOption("mute-on-focus-loss", "mute audio when Space Connect window loses focus");
