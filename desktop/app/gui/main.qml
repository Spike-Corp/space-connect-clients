...
ApplicationWindow {
    ...
    header: ToolBar {
        ...
        // "Space Connect" display font for the toolbar title - same Orbitron
        // typeface used for headings/wordmarks on the Android client.
        FontLoader {
        ...
        RowLayout {
            ...
            Label {
                ...
                text: qsTr("Connect %1").arg(SystemProperties.versionString)
                font.pointSize: 12
            ...
            NavigableToolButton {
                ...
                onClicked: Qt.openUrlExternally("https://discord.gg/AuymrNWYer");
            ...
            NavigableToolButton {
                ...
                ToolTip.timeout: 3000
                ToolTip.visible: hovered
                ToolTip.text: qsTr("Browse the GamingFlix game catalog")

                // TODO need to make sure browser is brought to foreground.
                onClicked: Qt.openUrlExternally("https://gamingflix.space/catalogo");
    ...
    ErrorMessageDialog {
        ...
        text: qsTr("No functioning hardware accelerated video decoder was detected by Space Connect. " +
    ...
    NavigableMessageDialog {
        ...
        text: qsTr("This version of Space Connect isn't optimized for your PC. Please download the '%1' version of Space Connect for the best streaming performance.").arg(SystemProperties.friendlyNativeArchName)
        onAccepted: {
    ...
    ErrorMessageDialog {
        ...
        text: qsTr("Space Connect detected gamepads without a mapping:") + "\n" + unmappedGamepads
        helpTextSeparator: "\n\n"
