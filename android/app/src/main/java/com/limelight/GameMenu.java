...
public class GameMenu {
    ...
    public void showMenu() {
        ...
        options.add(new MenuOption(getString(game.areOnScreenControlsHidden() ?
                R.string.game_menu_show_controls : R.string.game_menu_hide_controls), game::toggleOnScreenControls));
