...
public class ComputerDetails {
    ...
    // GPU model string reported by the host (e.g. "Tesla T4", "NVIDIA L4"), used to decide
    // whether to unlock the higher 50 Mbps bitrate tier on Space Cloud's dedicated
    // "physical machine" hardware. May be null if the host didn't report it.
