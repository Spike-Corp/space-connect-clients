...
public class MediaCodecHelper {
    ...
    static {
        ...
        // Blacklist software decoders that don't perform well enough for streaming except on
        // systems that are expected to only have software decoders (like emulators).
