...
// Ported from Artemis: "free" analog stick variant. Unlike AnalogStick (which requires
// the finger to land on the small fixed-position nub), this variant recenters the whole
// stick wherever the finger first touches down inside the element's bounds, making it much
// easier to hit on a touchscreen. Gated behind the "checkbox_enable_analog_stick_new" preference.
