...
/**
 * Ported from Artemis (github.com/MobinYengejehi/Artemis, a moonlight-android fork). Implements
 * a tap/click/drag/scroll gesture-based "natural" trackpad mode (as opposed to
 * RelativeTouchContext's direct 1:1 relative-motion "gaming" trackpad mode) - single tap =
 * click, two-finger tap = right click, drag = move, two-finger drag = scroll.
 */
