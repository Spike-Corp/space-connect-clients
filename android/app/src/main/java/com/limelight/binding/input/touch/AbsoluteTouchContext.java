...
public class AbsoluteTouchContext implements TouchContext {
    ...
    // Ported from Artemis: lets AbsoluteTouchContext swap which physical mouse button (left
    // vs. right click semantics) tap-vs-long-press maps to, for left-handed use.
