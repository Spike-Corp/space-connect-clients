...
public class KeyboardTranslator implements InputManager.InputDeviceListener {
    ...
    public short translate(int keycode, int deviceId) {
        ...
        // Force qwerty will break the user's keyboard layout settings, so this can be
        // disabled (ported from Artemis) for users with a non-QWERTY physical keyboard
        // they want passed through unmodified.
