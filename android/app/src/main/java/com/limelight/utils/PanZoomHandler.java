 ...
 * Handles pinch-to-zoom and pan gestures on the stream view when Game's pan/zoom mode is
 * enabled (see Game.isZoomModeEnabled()/toggleZoomMode()) - while active, this replaces normal
 * touch/mouse/OSC handling entirely (see the isPanZoomMode check in Game's touch handling).
 */
