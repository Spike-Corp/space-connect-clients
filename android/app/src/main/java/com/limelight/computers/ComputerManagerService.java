...
public class ComputerManagerService extends Service {
    ...
    public class ComputerManagerBinder extends Binder {
        public void startPolling(ComputerManagerListener listener) {
            ...
            // NOTE: mDNS/local network autodiscovery is intentionally disabled - this client
            // only ever connects to the user's own cloud VM (provisioned via spacecloud.gg),
            // never to a PC on the local network, so we don't want to identify/list any local
            // GameStream/Sunshine hosts a user might happen to have on their LAN.
